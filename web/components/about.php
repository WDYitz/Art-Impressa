    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div class="reveal-right mt-12 lg:mt-0">
        ...
        <div class="flex items-center gap-3 mb-5">
          ...
          <span class="text-[#64d4f6] uppercase tracking-widest text-[0.75rem] font-medium">Sobre Nós</span>
        </div>
        ...
        <h2 class="text-[#0D0D0D] mb-6"
          ...
          <em class="not-italic italic text-[#64d4f6]">Impressões Inesquecíveis</em>
        </h2>
