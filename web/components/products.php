          ...
          >
            <div class="p-7 flex flex-col gap-4 h-full">
              ...
              <div class="flex items-center gap-1.5 transition-opacity duration-300 mt-1">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#C9973B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>
                </svg>
                <span style="color:#C9973B;font-size:0.72rem;font-weight:500;letter-spacing:0.08em;text-transform:uppercase;">
                  Ver Galeria
                </span>
              </div>
            </div>
  ...
  <div class="pgm-container">
    ...
    <div class="pgm-main-wrap">
      ...
      <div class="pgm-empty" id="pgm-empty" hidden>
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#C9973B" stroke-width="1.5" stroke-linecap="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
...
(function () {
  ...
  zoomArea.addEventListener('touchend', () => { lastTouchDist = null; });
  /* ── Zoom buttons ── */
